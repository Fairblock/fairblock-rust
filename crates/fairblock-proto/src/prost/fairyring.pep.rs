...
pub struct Params {
    ...
    pub private_decryption_key_price: ::core::option::Option<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
    #[prost(uint64, tag="7")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ExecuteContractPrivateMsg {
    #[prost(string, tag="1")]
    pub identity: ::prost::alloc::string::String,
    #[prost(message, optional, tag="2")]
    pub private_decryption_key: ::core::option::Option<super::common::PrivateDecryptionKey>,
}
